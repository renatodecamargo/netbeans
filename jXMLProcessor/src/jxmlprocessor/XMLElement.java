...
public class XMLElement {
    ...
    protected  int DataManipNumber = 0;    // Numero do DataManip
    protected  int StepInDataManipNumber = 0;  // Numero do Step
    protected  String Label = "";            // Label do Objeto 
    protected  String Object = "";           // Nome do Objeto
    protected  String ObjectType = "";       // Tipo do Objeto
    protected  boolean Block = false;           // Objeto faz parte de Bloco
    ...
    public String getInsertCommand() {
       ...
       return "insert into xmlelements (xmlsourcefile,xmlfrontend,xmlmodule,targetfile,datamanipnumber,stepindatamanipnumber,label,object,objecttype,block,filtertype,objectfilter,blockfilter,parameters,container,link) values ( \"" + XmlSourceFile + "\",\"" + XmlFrontEnd + "\",\"" + XmlModule + "\",\"" + TargetFile + "\"," + DataManipNumber + "," + StepInDataManipNumber + ",\"" + Label  + "\",\"" + Object + "\",\"" + ObjectType + "\"," + (Block?1:0) + ",\"" + FilterType + "\",\"" + ObjectFilter + "\",\"" + BlockFilter + "\",\"" + Parameters + "\",\"" + Container + "\",\"" + Link + "\")"; 
